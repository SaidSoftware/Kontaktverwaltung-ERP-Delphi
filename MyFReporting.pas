...
uses
  ...
  dxSkinXmas2008Blue, cxGeometry, dxFramedControl, dxPanel, dxCore,
  ...
  dxGallery, dxRibbonGallery, dxRibbonMarginsGallery, dxBar,
  dxRibbonColorGallery, cxBarEditItem, dxPrinting, cxClasses, dxRibbon,
  System.Actions, Vcl.ActnList, dxActions, System.ImageList, Vcl.ImgList,
  cxImageList, dxSpreadSheetCore, dxSpreadSheetReportDesigner,KVDataModule;

type
  TFormReporting = class(TForm)
    dxPanelReporting: TdxPanel;
    ...
    dxBarDefinedNames: TdxBar;
    dxBarLargeButtonNameManager: TdxBarLargeButton;
